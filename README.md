<div>
    <h1>🍅 Pomodoro</h1>
    <p>Detro desse projeto criei um temporizador para ser utilizado na técnica de concentração pomodoro.
    O objetivo desse projeto foi treinar Programação Orientada a Objetos, em JavaScript, e ser algo simples e bonito.</p>
</div>
<div>
...
<div>
    <h2>⏱️ Resultado</h2>
    <img align="center" alt="Resultado" src="./assets/img/ResultadoPomodoro.jpg"/>
</div>
